...
def train_model_sol():
    ...
    return model.save("my_model_sol.h5")
...
def sol_model_prediction():
    ...
    model = keras.models.load_model('my_model_sol.h5')
...
def sol_get_new_prediction():
    ...
    addName = "["+json_result+","+"{\"name\": \"SOL\"}, {\"RMSE\":"+ sol_get_rmse()+"},{\"R-Square\":"+ sol_get_r2()+"},{\"MAPE\":"+ sol_get_mape()+"}]"
    return addName
